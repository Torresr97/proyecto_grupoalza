...
if (isset($_GET["id1"]) && isset($_GET["id2"])) {
    ...
    $id = $_GET["id1"];
    $nombreequipo = $_GET["id2"];
 
    // mostrar $phpVar1 y $phpVar2
    echo "<p>Parameters: " . $id . " " . $nombreequipo . "</p>";
} else {
...
<div class="">
  ...
  <div class="clearfix"></div>
	...
	if($nombreequipo == 'DESKTOP'){
					...
					$sql = "SELECT * FROM V_equiposdesktop  Where idequipo = $id";
					...
					<div class="form-group row ">
						...
						<div class="col-md-4 col-sm-4 ">
							<input id="midequipo" name="midequipo" value="<?php echo $row['nombreequipo'] ?>" type="text" class="form-control" readonly>
						</div>
					</div>
					<div class="form-group row ">
